...
var ModalUnstyled = React29.forwardRef(function ModalUnstyled2(props, ref) {
  ...
  return (0, import_jsx_runtime14.jsx)(Portal_default, {
    ...
    children: (0, import_jsx_runtime15.jsxs)(Root, _extends({}, rootProps, {
      children: [!hideBackdrop && BackdropComponent ? (0, import_jsx_runtime14.jsx)(BackdropComponent, _extends({}, backdropProps)) : null, (0, import_jsx_runtime14.jsx)(TrapFocus_default, {
        disableEnforceFocus,
        disableAutoFocus,
        disableRestoreFocus,
...
var _span3;
var _span4;
var LastPageIconDefault = () => _span || (_span = (0, import_jsx_runtime30.jsx)("span", {
  children: "\u21FE|"
}));
var FirstPageIconDefault = () => _span2 || (_span2 = (0, import_jsx_runtime30.jsx)("span", {
  children: "|\u21FD"
}));
var NextPageIconDefault = () => _span3 || (_span3 = (0, import_jsx_runtime30.jsx)("span", {
  children: "\u21FE"
}));
var BackPageIconDefault = () => _span4 || (_span4 = (0, import_jsx_runtime30.jsx)("span", {
  children: "\u21FD"
}));
...
var useTabsList = (parameters) => {
  ...
  const processChildren = React49.useCallback(() => {
    ...
    let childIndex = 0;
    const processedChildren = React49.Children.map(children2, (child) => {
...
var useInsertionEffect2 = React53["useInsertionEffect"] ? React53["useInsertionEffect"] : false;
...
function InnerThemeProvider(props) {
  ...
  return (0, import_jsx_runtime44.jsx)(ThemeContext.Provider, {
...
function ThemeProvider3(props) {
  ...
  return (0, import_jsx_runtime44.jsx)(ThemeProvider_default, {
    theme: localTheme,
    children: (0, import_jsx_runtime44.jsx)(InnerThemeProvider, {
      children: children2
    })
  });
}
...
function createContainer(options = {}) {
  ...
  const Container2 = React64.forwardRef(function Container3(inProps, ref) {
    ...
    return (0, import_jsx_runtime48.jsx)(ContainerRoot, _extends({
      as: component,
      ownerState,
...
function joinChildren(children2, separator) {
  const childrenArray = React66.Children.toArray(children2).filter(Boolean);
...
var Transition = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return import_react16.default.createElement(TransitionGroupContext_default.Provider, {
      value: null
    }, typeof children2 === "function" ? children2(status, childProps) : import_react16.default.cloneElement(import_react16.default.Children.only(children2), childProps));
  };
  return Transition2;
...
function getNextChildMapping(nextProps, prevChildMapping, onExited) {
  ...
  Object.keys(children2).forEach(function(key) {
    ...
    if (hasNext && (!hasPrev || isLeaving)) {
      children2[key] = (0, import_react17.cloneElement)(child, {
        onExited: onExited.bind(null, child),
        in: true,
...
var ReplaceTransition = function(_React$Component) {
  ...
  _proto.handleLifecycle = function handleLifecycle(handler, idx, originalArgs) {
    ...
    var child = import_react20.default.Children.toArray(children2)[idx];
  ...
  _proto.render = function render() {
    ...
    var _React$Children$toArr = import_react20.default.Children.toArray(children2), first = _React$Children$toArr[0], second = _React$Children$toArr[1];
    ...
    return import_react20.default.createElement(TransitionGroup_default, props, inProp ? import_react20.default.cloneElement(first, {
      key: "first",
      onEnter: this.handleEnter,
      onEntering: this.handleEntering,
      onEntered: this.handleEntered
    }) : import_react20.default.cloneElement(second, {
      key: "second",
...
ReplaceTransition.propTypes = true ? {
  ...
  children: function children(props, propName) {
    if (import_react20.default.Children.count(props[propName]) !== 2)
...
function areChildrenDifferent(oldChildren, newChildren) {
  if (oldChildren === newChildren)
    return false;
  if (import_react21.default.isValidElement(oldChildren) && import_react21.default.isValidElement(newChildren) && oldChildren.key != null && oldChildren.key === newChildren.key) {
    return false;
  }
  return true;
}
...
var leaveRenders = (_leaveRenders = {}, _leaveRenders[modes.out] = function(_ref) {
  ...
  return import_react21.default.cloneElement(current, {
    in: false,
  ...
  return [current, import_react21.default.cloneElement(children2, {
    in: true,
...
var enterRenders = (_enterRenders = {}, _enterRenders[modes.out] = function(_ref3) {
  ...
  return import_react21.default.cloneElement(children2, {
    in: true,
    onEntered: callHook(children2, "onEntered", function() {
      changeState(ENTERED, import_react21.default.cloneElement(children2, {
        in: true
      }));
    })
  });
  ...
  }), import_react21.default.cloneElement(children2, {
    in: true
  })];
}, _enterRenders);
var SwitchTransition = function(_React$Component) {
  ...
  SwitchTransition2.getDerivedStateFromProps = function getDerivedStateFromProps(props, state) {
    ...
    return {
      current: import_react21.default.cloneElement(props.children, {
        in: true
      })
    };
  };
 ...
 * LICENSE file in the root directory of this source tree.
 */
//# sourceMappingURL=chunk-QN6YLBCF.js.map
